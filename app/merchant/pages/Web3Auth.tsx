...
function App() {
  ...
  const loggedInView = (
    <>
      <button
        onClick={onOpen}
        className="text-white bg-purple-600 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
      >
        Manage Wallet
      </button>
  ...
  const unloggedInView = (
    <button 
    className="text-white bg-purple-600 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
    onClick={login}>
      Login
    </button>
  );
